...
ui <- fluidPage(
    ...
    h5('위험계정비중 가감요인을 적용할 때, 금융업 회사의 경우 유가증권과 파생상품, 건설업의 경우 미청구공사금액 등 회사 개별특성 및 고유환경에 따라 재고자산 및 매출채권 이외에 위험이 높은 계정이 있는 경우 이를 포함하여 위험계정비중을 고려하는 것이 더 합리적이라고 판단된다면 이들 자산을 위험계정에 포함할 수 있음'),
